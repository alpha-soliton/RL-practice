...
import tendon_walker2d_v2_odd_reference_fix_legsin_fix
...
def main():
    ...
    parser.add_argument('--cycle-of-ref', type=int, default=200,
                        help='Cycle of reference motion for training.')
    parser.add_argument('--ref-coeff', type=int, default=2,
                        help='Coefficient of reference motion factor in reward function.')
    ...
    def make_env(test):
        env = tendon_walker2d_v2_odd_reference_fix_legsin_fix.TendonWalker2dv2OddReferenceEnv(args.cycle_of_ref, args.ref_coeff)
