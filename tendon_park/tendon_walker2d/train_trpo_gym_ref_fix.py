...
import tendon_walker2d_reference_fix
...
def main():
    ...
    parser.add_argument('--cycle-of-ref', type=int, default=20,
    ...
    def make_env(test):
        env = tendon_walker2d_reference_fix.TendonWalker2dReferenceEnv(args.cycle_of_ref)
